                ...
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color dark:text-gray-300">oradam200@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="/contact/submit" method="POST" x-data="{
                        ...
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Your Message" name="message" rows="6"
                                x-model="formData.message" ::class="errors.message ? 'border-red-500 focus:border-red-500' : ''">
                            </x-forms.textarea>
