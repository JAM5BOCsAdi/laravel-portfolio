            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    <h1
                        ...
                        My Name is Adam. <br />
                        I am <span class="rounded-md text-amber-600">a Developer</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        ...
                        <a class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
                            href="https://www.youtube.com/channel/UCYGlVtACi_4kXvJIvf7Xaqg" target="_blank">YouTube
                            Channel</a>. <br>
                    </p>
            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="lg:text-right lg:ml-auto">
                    <div class="relative inline-block z-10 pt-11 lg:pt-0">
                        <img src="{{ url('/img/person1.jpg') }}" alt="hero" class="max-w-full lg:ml-auto" />
